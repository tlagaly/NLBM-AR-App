...
public class VideoPlaybackBehaviour : MonoBehaviour
{
        ...
        else
        {
            ...
            if (isPlayableOnTexture)
            {
                ...
                if (videoWidth > 0 && videoHeight > 0)
                {
                    ...
                    // Flip the plane as the video texture is mirrored on the horizontal
                    transform.localScale = new Vector3(-0.2f, 0.2f, 0.2f * aspect);
                }
    ...
    {
        // Icon should fill 35% of the narrowest side of the video
        ...
        {
            iconWidth = 0.25f * videoHeight / videoWidth;
            iconHeight = 0.25f;
        }
        else
        {
            iconWidth = 0.25f;
            iconHeight = 0.25f * videoWidth / videoHeight;
        }
